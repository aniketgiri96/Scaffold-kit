...
interface ComponentPreviewProps extends React.HTMLAttributes<HTMLDivElement> {
  ...
  /** Shadcn CLI slug for primitives (e.g. "button"). Builds command: pnpm ui:add <slug>. */
  cliSlug?: string;
  /** Full CLI command when using namespaced registries (e.g. "pnpm ui:add @templates/chat-message-row"). Takes precedence over cliSlug when set. */
...
export function ComponentPreview({
  ...
  const cliCommand = cliInstallCommand ?? (cliSlug ? `pnpm ui:add ${cliSlug}` : undefined);
