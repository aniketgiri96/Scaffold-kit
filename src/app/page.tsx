      ...
      <main className="flex-1 relative z-10">
        <section className="space-y-6 pb-8 pt-6 md:pb-12 md:pt-10 lg:py-32">
          <div className="container mx-auto px-4 flex max-w-[64rem] flex-col items-center gap-4 text-center">
            <h1 className="font-bold text-3xl sm:text-5xl md:text-6xl lg:text-7xl tracking-tighter bg-clip-text text-transparent bg-gradient-to-b from-foreground to-foreground/70">
            ...
            <div className="space-x-4 pt-4">
              ...
              <Button size="lg" variant="outline" className="h-12 px-8 rounded-full border-border bg-muted/50 backdrop-blur-md hover:bg-muted transition-transform hover:scale-105 active:scale-95" asChild>
